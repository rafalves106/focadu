 ...
 * grudadas no texto (ver WeeklyProjectCard). O texto completo (com formatacao real) vai pra
 * WeeklyProjectPage via MarkdownBlock - esta funcao e so pro resumo truncado.
 */
