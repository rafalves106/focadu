...
namespace Focadu.Infrastructure.Migrations
{
    ...
    [Migration("20260925021004_SquadHqCheersAndFeedPrivacy")]
    partial class SquadHqCheersAndFeedPrivacy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Focadu.Domain.Activities.ActivityResponse", b =>
                {
                    ...
                    b.Property<string>("CorrectedTranscript")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Focadu.Domain.Activities.WordMatchPair", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WordMatchPairs", (string)null);
                });
            ...
            modelBuilder.Entity("Focadu.Domain.Content.PersonalizedAnalogy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CuratedContentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CuratedContentId");

                    b.HasIndex("UserId", "CuratedContentId")
                        .IsUnique();

                    b.ToTable("PersonalizedAnalogies", (string)null);
                });
            ...
            modelBuilder.Entity("Focadu.Domain.Dailies.DailyTemplate", b =>
                {
                    ...
                    b.HasIndex("WeeklyTemplateId", "DayNumber", "Language")
                        .IsUnique();
            ...
            modelBuilder.Entity("Focadu.Domain.Gamification.UserStreak", b =>
                {
                    ...
                    b.Property<DateOnly?>("LastRestDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Focadu.Domain.GitHosting.UserForgejoAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TokenLastEight")
                        .HasMaxLength(8)
                    ...
                    b.ToTable("UserForgejoAccounts", (string)null);
                });

            modelBuilder.Entity("Focadu.Domain.Monthlies.CertificationCoverage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CoveredDomains")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("MonthlyId", "CertificationCode")
                        .IsUnique();

                    b.ToTable("CertificationCoverages", (string)null);
                });
            ...
            modelBuilder.Entity("Focadu.Domain.Notes.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("WeeklyProjectId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("UserId", "DailyId");

                    b.HasIndex("UserId", "WeeklyProjectId");

                    b.ToTable("Notes", null, t =>
                        {
                            t.HasCheckConstraint("CK_Notes_ExactlyOneContext", "(\"DailyId\" IS NULL) <> (\"WeeklyProjectId\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Focadu.Domain.Squads.SquadCheer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SquadId", "ActivityKey", "FromUserId")
                        .IsUnique();

                    b.ToTable("SquadCheers", (string)null);
                });

            modelBuilder.Entity("Focadu.Domain.Squads.SquadMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SquadMemberships", (string)null);
                });

            modelBuilder.Entity("Focadu.Domain.Users.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Focadu.Domain.Users.User", b =>
                {
                    ...
                    b.Property<bool>("HideScoresInSquadFeed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("Focadu.Domain.Weeklies.WeeklyTemplate", b =>
                {
                    ...
                    b.Property<string>("ForgejoTemplateSlug")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Focadu.Domain.Weeklies.WeeklyTemplateLanguage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WeeklyTemplateId", "Language")
                        .IsUnique();

                    b.ToTable("WeeklyTemplateLanguages", (string)null);
                });

            modelBuilder.Entity("Focadu.Domain.Weeklies.WeeklyTemplateReference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WeeklyTemplateId", "Position");

                    b.ToTable("WeeklyTemplateReferences", (string)null);
                });
            ...
            modelBuilder.Entity("Focadu.Domain.Content.PersonalizedAnalogy", b =>
                {
                    b.HasOne("Focadu.Domain.Content.CuratedContent", null)
                        .WithMany()
                        .HasForeignKey("CuratedContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsMany("Focadu.Domain.Content.AnalogySection", "_sections", b1 =>
                        {
                            b1.Property<Guid>("PersonalizedAnalogyId")
                                .HasColumnType("uuid");

                            b1.Property<int>("SectionIndex")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("PersonalizedAnalogyId", "SectionIndex");

                            b1.ToTable("PersonalizedAnalogySections", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("PersonalizedAnalogyId");
                        });
            ...
            modelBuilder.Entity("Focadu.Domain.Monthlies.CertificationCoverage", b =>
                {
                    b.HasOne("Focadu.Domain.Monthlies.Monthly", null)
                        .WithMany("CertificationCoverages")
            ...
            modelBuilder.Entity("Focadu.Domain.Squads.SquadCheer", b =>
                {
                    ...
                    b.HasOne("Focadu.Domain.Squads.Squad", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Focadu.Domain.Monthlies.Monthly", b =>
                {
                    b.Navigation("CertificationCoverages");
